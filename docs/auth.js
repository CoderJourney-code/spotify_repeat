...
// let scope = ['app-remote-control', 'streaming', 'user-modify-playback-state',  'user-read-currently-playing',  'user-read-email',  'user-read-playback-position',  'user-read-playback-state',  'user-read-private',  'user-read-recently-played'].join(' ');
// console.log(scope)
...
function spotifyJunk() { 
  ...
  try { 
    window.onSpotifyWebPlaybackSDKReady = playerFunction(currentToken.access_token);
  }
  catch(err) { 
    console.log("Error in onSpotifyWebPlaybackSDKReady: ", err);
  }
